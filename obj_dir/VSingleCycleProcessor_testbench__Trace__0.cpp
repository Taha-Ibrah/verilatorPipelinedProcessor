...
void VSingleCycleProcessor_testbench___024root__trace_chg_0_sub_0(VSingleCycleProcessor_testbench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgQData(oldp+19,((vlSelfRef.SingleCycleProcessor_testbench__DOT__currentpc 
                                 + (vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__extimm 
                                    << 2U))),64);
        bufp->chgIData(oldp+21,((0x03ffffffU & vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__instruction)),26);
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        bufp->chgQData(oldp+22,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__regoutA),64);
        bufp->chgQData(oldp+24,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__regoutB),64);
        bufp->chgQData(oldp+26,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__aluout),64);
        bufp->chgBit(oldp+28,((0ULL == vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__aluout)));
        bufp->chgQData(oldp+29,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__alu_input_b),64);
    }
    ...
    bufp->chgQData(oldp+40,(((1U & (((0ULL == vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__aluout) 
                                     & ((IData)(vlSelfRef.__VdfgRegularize_hebeb780c_0_0) 
    ...
    bufp->chgBit(oldp+44,((1U & (((0ULL == vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__aluout) 
                                  & ((IData)(vlSelfRef.__VdfgRegularize_hebeb780c_0_0) 
                                     >> 2U)) | ((IData)(vlSelfRef.__VdfgRegularize_hebeb780c_0_0) 
                                                >> 1U)))));
