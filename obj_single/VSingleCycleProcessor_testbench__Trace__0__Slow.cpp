...
VL_ATTR_COLD void VSingleCycleProcessor_testbench___024root__trace_full_0_sub_0(VSingleCycleProcessor_testbench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+2,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__imem__DOT__Instruction),32);
    bufp->fullCData(oldp+3,((0x0000001fU & vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__imem__DOT__Instruction)),5);
    bufp->fullCData(oldp+4,((0x0000001fU & (vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__imem__DOT__Instruction 
                                            >> 5U))),5);
    bufp->fullCData(oldp+5,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__regfile__DOT__readRegister2),5);
    bufp->fullSData(oldp+6,((vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__imem__DOT__Instruction 
                             >> 0x00000015U)),11);
    ...
    bufp->fullCData(oldp+16,((3U & ((IData)(vlSelfRef.__VdfgRegularize_hebeb780c_0_0) 
                                    >> 8U))),2);
    bufp->fullQData(oldp+17,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__signext__DOT__BusImm),64);
    bufp->fullQData(oldp+19,((vlSelfRef.SingleCycleProcessor_testbench__DOT__currentpc 
                              + (vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__signext__DOT__BusImm 
                                 << 2U))),64);
    bufp->fullIData(oldp+21,((0x03ffffffU & vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__imem__DOT__Instruction)),26);
    bufp->fullQData(oldp+22,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__alu__DOT__BusA),64);
    bufp->fullQData(oldp+24,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__datamem__DOT__WriteData),64);
    bufp->fullQData(oldp+26,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__alu__DOT__BusW),64);
    bufp->fullBit(oldp+28,((0ULL == vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__alu__DOT__BusW)));
    bufp->fullQData(oldp+29,(vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__alu__DOT__BusB),64);
    ...
    bufp->fullQData(oldp+40,(((1U & (((0ULL == vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__alu__DOT__BusW) 
                                      & ((IData)(vlSelfRef.__VdfgRegularize_hebeb780c_0_0) 
                                         >> 2U)) | 
                                     ((IData)(vlSelfRef.__VdfgRegularize_hebeb780c_0_0) 
    ...
    bufp->fullBit(oldp+44,((1U & (((0ULL == vlSelfRef.SingleCycleProcessor_testbench__DOT__uut__DOT__alu__DOT__BusW) 
                                   & ((IData)(vlSelfRef.__VdfgRegularize_hebeb780c_0_0) 
